...
- [[test_dm_call_edges_have_call_context()]] - `calls` [EXTRACTED]
- [[test_dm_emits_include_edge()]] - `calls` [EXTRACTED]
- [[test_dm_unresolved_include_flagged_external()]] - `calls` [EXTRACTED]
