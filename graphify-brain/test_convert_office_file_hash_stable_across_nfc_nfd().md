...
# test_convert_office_file_hash_stable_across_nfc_nfd()

## Connections
- [[The sidecar name must be identical whether the source path arrives in     NFC or]] - `rationale_for` [EXTRACTED]
