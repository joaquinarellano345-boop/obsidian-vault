...
# test_rebuild_lock_non_blocking_does_not_clobber_holder()

## Connections
- [[GH-858 a non-blocking caller that fails to acquire the lock must not     trunca]] - `rationale_for` [EXTRACTED]
