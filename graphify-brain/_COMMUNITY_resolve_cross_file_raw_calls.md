...
```dataview
TABLE source_file, type FROM #community/resolve_cross_file_raw_calls
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_test_symbol_resolution.py]]
...
## Top bridge nodes
- [[resolve_cross_file_raw_calls()]] - degree 16, connects to 5 communities
