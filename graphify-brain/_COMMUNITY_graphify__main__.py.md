...
- [[Remove .windsurfrulesgraphify.md.]] - rationale - graphify/install.py
- [[Remove JSONC-style comments while leaving string content intact.]] - rationale - graphify/install.py
- [[Remove Kilo always-on project wiring and global skillcommand files.]] - rationale - graphify/install.py
- [[Remove a platform skill file and its version stamp without touching other scopes]] - rationale - graphify/install.py
- [[Remove every section whose heading line is exactly ``marker``.      The heading]] - rationale - graphify/install.py
- [[Remove graphify Antigravity rules, workflow, and skill files.]] - rationale - graphify/install.py
- [[Remove graphify PreToolUse hook from .codebuddysettings.json.]] - rationale - graphify/install.py
- [[Remove graphify PreToolUse hook from .codexhooks.json.]] - rationale - graphify/install.py
- [[Remove graphify VS Code Copilot Chat skill and .githubcopilot-instructions.md s]] - rationale - graphify/install.py
- [[Remove graphify from every platform detected in the current project.]] - rationale - graphify/install.py
- [[Remove graphify skill + steering file for Kiro.]] - rationale - graphify/install.py
- [[Remove graphify.js plugin and deregister from opencode.json.]] - rationale - graphify/install.py
- [[Remove graphify.js plugin and deregister it without rewriting user JSONC.]] - rationale - graphify/install.py
- [[Remove project-scoped install files without touching user-scope installs.]] - rationale - graphify/install.py
- [[Remove project-scoped platform skillconfig files only.]] - rationale - graphify/install.py
- [[Remove the graphify PreToolUse hook from .claudesettings.json and its     local]] - rationale - graphify/install.py
- [[Remove the graphify section from GEMINI.md, uninstall hook, and remove skill fil]] - rationale - graphify/install.py
...
- [[Write .cursorrulesgraphify.mdc with alwaysApply true.]] - rationale - graphify/install.py
- [[Write .windsurfrulesgraphify.md for always-on Devin context.]] - rationale - graphify/install.py
- [[Write Antigravity's always-on layer next to an installed skill.      Injects the]] - rationale - graphify/install.py
- [[Write automated Kilo edits to kilo.json so existing JSONC stays untouched.]] - rationale - graphify/install.py
- [[Write graphify skill + steering file for Kiro IDECLI.]] - rationale - graphify/install.py
- [[Write graphify.js plugin and register it in opencode.json.]] - rationale - graphify/install.py
- [[Write graphify.js plugin and register it without rewriting user JSONC.]] - rationale - graphify/install.py
- [[Write the graphify section to the local AGENTS.md for always-on platforms.]] - rationale - graphify/install.py
- [[__getattr__()_1]] - code - graphify/__main__.py
- [[_agents_install()]] - code - graphify/install.py
- [[_agents_platform_install()]] - code - graphify/install.py
- [[_agents_platform_uninstall()]] - code - graphify/install.py
- [[_agents_uninstall()]] - code - graphify/install.py
- [[_always_on()]] - code - graphify/install.py
- [[_amp_install()]] - code - graphify/install.py
- [[_amp_legacy_cleanup()]] - code - graphify/install.py
- [[_amp_uninstall()]] - code - graphify/install.py
- [[_antigravity_finalize()]] - code - graphify/install.py
...
- [[_kilo_config_path()]] - code - graphify/install.py
- [[_kilo_config_write_path()]] - code - graphify/install.py
- [[_kilo_install()]] - code - graphify/install.py
- [[_kilo_uninstall()]] - code - graphify/install.py
- [[_kilo_uninstall_global()]] - code - graphify/install.py
- [[_kiro_install()]] - code - graphify/install.py
- [[_kiro_uninstall()]] - code - graphify/install.py
- [[_load_json_like()]] - code - graphify/install.py
- [[_packaged_skill_refs_dir()]] - code - graphify/install.py
- [[_platform_skill_destination()]] - code - graphify/install.py
- [[_print_banner()]] - code - graphify/install.py
- [[_print_install_usage()]] - code - graphify/install.py
- [[_print_project_git_add_hint()]] - code - graphify/install.py
- [[_project_install()]] - code - graphify/install.py
...
- [[_uninstall_claude_hook()]] - code - graphify/install.py
- [[_uninstall_codebuddy_hook()]] - code - graphify/install.py
- [[_uninstall_codex_hook()]] - code - graphify/install.py
...
```dataview
TABLE source_file, type FROM #community/graphify/__main__py
SORT file.name ASC
```
