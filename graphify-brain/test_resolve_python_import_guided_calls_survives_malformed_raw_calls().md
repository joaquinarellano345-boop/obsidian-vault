...
# test_resolve_python_import_guided_calls_survives_malformed_raw_calls()

## Connections
- [[Python import-guided resolver also tolerates malformed raw_calls.]] - `rationale_for` [EXTRACTED]
