...
# test_pg_introspect_fk_edges_survive_unparseable_function_stubs()

## Connections
- [[1854 FK edges must survive routines whose reconstructed DDL the SQL     gramma]] - `rationale_for` [EXTRACTED]
- [[_make_mock_psycopg()]] - `calls` [EXTRACTED]
- [[_q()]] - `calls` [EXTRACTED]
