...
- [[_alias_extraction()]] - `contains` [EXTRACTED]
...
- [[report.py]] - `imports_from` [EXTRACTED]
...
- [[test_build_canonical_nodes_wins_over_alias()]] - `contains` [EXTRACTED]
- [[test_build_dedups_alias_members_preserving_order()]] - `contains` [EXTRACTED]
- [[test_build_from_json_missing_hyperedges_key()]] - `contains` [EXTRACTED]
- [[test_build_from_json_no_hyperedges()]] - `contains` [EXTRACTED]
- [[test_build_from_json_relativizes_hyperedge_source_file()]] - `contains` [EXTRACTED]
- [[test_build_from_json_stores_hyperedges()]] - `contains` [EXTRACTED]
- [[test_build_normalizes_member_aliases_to_nodes()]] - `contains` [EXTRACTED]
- [[test_build_rekeys_alias_keyed_hyperedge_members()]] - `contains` [EXTRACTED]
- [[test_build_warns_once_per_aliased_hyperedge()]] - `contains` [EXTRACTED]
