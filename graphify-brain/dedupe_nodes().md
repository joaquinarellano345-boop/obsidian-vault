...
## Connections
- [[Collapse nodes sharing an ``id``, last-writer-wins on attributes.      Mirrors w]] - `rationale_for` [EXTRACTED]
...
- [[test_dedupe_nodes_collapses_by_id_last_wins()]] - `calls` [EXTRACTED]
