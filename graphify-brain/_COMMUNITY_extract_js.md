...
- 19 edges to [[_COMMUNITY_test_extract.py]]
- 16 edges to [[_COMMUNITY_test_import_extension_resolution.py]]
- 9 edges to [[_COMMUNITY_test_languages.py]]
- 9 edges to [[_COMMUNITY_test_multilang.py]]
- 6 edges to [[_COMMUNITY_extract_python]]
...
## Top bridge nodes
- [[extract_js()]] - degree 72, connects to 14 communities
...
- [[test_ts_dynamic_import_alias_with_bare_path_resolves()]] - degree 4, connects to 1 community